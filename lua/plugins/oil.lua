  ...
  config = function()
    require('oil').setup {
      ...
      preview_win = {
        ...
        disable_preview = function(filename) return vim.fn.getfsize(filename) > 1024 * 1000 end,
        win_options = {},
      },
      confirmation = {
        max_width = 0.9,
    ...
    vim.api.nvim_create_autocmd('User', {
      ...
      callback = vim.schedule_wrap(function(args)
        ...
        if vim.api.nvim_get_current_buf() == args.data.buf and oil.get_cursor_entry() and vim.fn.winwidth '%' > 100 then oil.open_preview() end
      end),
    })
  end,
}
